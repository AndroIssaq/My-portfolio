...
const Navbar = () => {
  return (
    <nav className='w-[100%]  fixed p-[30px] relative'>
        <div className="container w-[90%] m-auto">
            ...
            <ul className='flex gap-[20px] flex-col'>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>Home</Link>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>Services</Link>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>About Me</Link>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>Blog</Link>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>Pages</Link>
                    <Link to='/' className='text-blue-900 font-bold hover:text-violet-600 text-[25px]'>Contact Me</Link>
                </ul>
            </div>
        </div>
        </div>
