        ...
        <div className="container w-[90%] m-auto">
            ...
            <div className="links">
                <ul className='flex gap-[20px]'>
                    ...
                    <Link to='/' className='text-blue-900 font-semibold'>Blog</Link>
                    <Link to='/' className='text-blue-900 font-semibold'>Pages</Link>
                    <Link to='/' className='text-blue-900 font-semibold'>Contact Me</Link>
                </ul>
            </div>
        </div>
        </div>
