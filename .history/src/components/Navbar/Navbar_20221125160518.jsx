        ...
        <div className="container w-[90%] m-auto">
            ...
            <div className="links">
                <ul className='flex gap-[20px]'>
                    <Link to='/' className='text-blue-900 font-semibold hover:text-violet-600 transition duration-300'>Home</Link>
                    <Link to='/' className='text-blue-900 font-semibold'>Services</Link>
                    <Link to='/' className='text-blue-900 font-semibold'>About Me</Link>
