  ...
  return (
    <nav className='w-[100%]   p-[30px] relative'>
        <div className="container w-[90%] m-auto">
            ...
            <div onClick={()=>toggleHandler(!toggle)} className="icons cursor-pointer text-[35px] text-black sm:hidden md:hidden block relative" >
                <FaBars/>

                
            </div>
            <div className={`mob-nav absolute w-[90%]  h-[400px] p-[40px] bg-black left-[50%] translate-x-[-50%] rounded-xl top-[100px] ${toggle?'nav-open':'nav-close'}`}>
