  ...
  return (
    <main className='w-[100%] sm:h-[100vh] md:h-[100vh] lg:h-auto h-auto '>
      ...
      <div className="hero mt-[100px] h-auto  w-[100%]">
        ...
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 600 , top:1 , bottom:1}}
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 400 , top:1 , bottom:1}}
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 900 , top:1 , bottom:1}}
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 1000 , top:1 , bottom:1}}
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
