  ...
  return (
    <main className='w-[100%] sm:h-[100vh] md:h-[100vh] lg:h-auto h-auto '>
      ...
      <div className="hero mt-[100px] h-auto  w-[100%]">
        ...
        className=' absolute z-[1] w-[15px] h-[15px] rounded-md bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        ...
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        ...
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 1000 , top:1 , bottom:600}}
        className=' absolute z-[1] w-[15px] h-[15px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
