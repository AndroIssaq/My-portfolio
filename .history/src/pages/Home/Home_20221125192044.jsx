  ...
  return (
    <main className='w-[100%] sm:h-[100vh] md:h-[100vh] lg:h-auto h-auto '>
      ...
      <motion.div ref={constraintsRef} className="hero overflow-hidden mt-[100px] h-auto  w-[100%]">
        ...
        className=' absolute z-[1] w-[50px] h-[50px] rounded-md bg-yellow-400 top-[20%] left-[13%]'>
        </motion.div>
        <motion.div 
        animate={{ x:'80px'}}
        drag
        ...
        drag
        dragConstraints={constraintsRef}
        className=' absolute z-[1] w-[50px] h-[50px] rounded-full bg-yellow-400 top-[30%] left-[4%]'>
        </motion.div>
        <motion.div 
        animate={{ x:'80px'}}
        drag
