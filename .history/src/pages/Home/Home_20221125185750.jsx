  ...
  return (
    <main className='w-[100%] sm:h-[100vh] md:h-[100vh] lg:h-auto h-auto '>
      ...
      <div className="hero mt-[100px] h-auto  w-[100%]">
        ...
        className=' absolute z-[1] w-[25px] h-[25px] rounded-full bg-yellow-400 top-[40%] left-[25%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 400 , top:1 , bottom:300}}
        className=' absolute z-[1] w-[50px] h-[50px] rounded-md bg-yellow-400 top-[40%] left-[60%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 900 , top:1 , bottom:200}}
        className=' absolute z-[1] w-[50px] h-[50px] rounded-full bg-yellow-400 top-[30%] left-[15%]'>
        </motion.div>
        <motion.div 
        drag
        dragConstraints={{ left:1, right: 1000 , top:1 , bottom:500}}
        className=' absolute z-[1] w-[25px] h-[25px] rounded-full bg-yellow-400 top-[20%] left-[15%]'>
        </motion.div>
