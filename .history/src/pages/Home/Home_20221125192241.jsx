  ...
  return (
    <main className='w-[100%] sm:h-[100vh] md:h-[100vh] lg:h-auto h-auto '>
      ...
      <motion.div ref={constraintsRef} className="hero overflow-hidden mt-[100px] h-auto  w-[100%]">
        ...
        drag
        dragConstraints={constraintsRef}
        className=' absolute z-[1] w-[50px] h-[50px] rounded-full bg-yellow-400 top-[20%] left-[47%]'>
        </motion.div>
        <motion.div 
        animate={{ x:'80px'}}
        drag
        dragConstraints={constraintsRef}
        className=' absolute z-[1] w-[50px] h-[50px] rounded-full bg-yellow-400 top-[30%] left-[35%]'>
        </motion.div>
        <motion.div 
        animate={{ x:'80px'}}
        drag
