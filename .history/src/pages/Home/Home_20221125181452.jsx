...
const Home = () => {
  return (
    <main className='w-[100%]  h-auto '>
      <Navbar/>
      <div className="hero mt-[100px] h-auto  ">
        <div className="content h-[100vh]  flex justify-between flex-wrap sm:gap-0 md:gap-0 gap-[50px] md:flex-row sm:flex-row lg:flex-row flex-col">
          <div className="title pl-[40px] text-blue-900  w-[600px] flex flex-col gap-[30px] justify-center  ">
          ...
          <div className="img  w-[600px] flex items-center justify-center  ">
