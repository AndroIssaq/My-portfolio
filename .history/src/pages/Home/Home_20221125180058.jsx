...
const Home = () => {
  return (
    <main className='w-[100%] sm:h-[100%] md:h-[100%] h-auto '>
      <Navbar/>
      <div className="hero w-[100%] sm:h-[83%] md:h-[83%] h-auto ">
        <div className="content w-[100%] h-[100%] flex justify-between flex-wrap">
