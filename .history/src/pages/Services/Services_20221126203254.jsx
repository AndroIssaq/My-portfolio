...
const Services = () => {
  return (
    <section className='mt-[50px]' >
        <div className="container w-[85%] mx-auto m-[20px] ">
            <div className="content flex items-center justify-center flex-col">
                <div className="title flex items-center justify-center flex-col gap-[40px]">
                    ...
                    <div className="lower-title flex flex-col items-center justify-center  gap-[20px] text-center">
                        <h1 className='sm:text-[50px] md:text-[50px] text-[20px] text-blue-900 font-bold'>Services I Can Help You With</h1>
                        <p  className='w-[450px] sm:w-[800px] md:w-[800px] text-slate-600 text-[20px]'> I always believe in high precision, accuracy, and quality work so definitely deliver neat and clean reusable code.
